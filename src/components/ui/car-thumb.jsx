 ...
 * car silhouette and the model name — always renders, no network needed.
 * When real photography is available, swap this for <Image src={car.image_url}/>.
 */

const palettes = [
  ["#0f4c81", "#0d3f6b", "#102c47"], // brand blue
  ["#134e63", "#0e3a4a", "#0b2733"], // teal
  ["#1e293b", "#0f172a", "#020617"], // slate night
  ["#3b3054", "#241d38", "#151022"], // plum
  ["#0f4c81", "#175e8f", "#0b3a63"], // azure
  ["#334155", "#1e293b", "#0f172a"], // graphite
];
